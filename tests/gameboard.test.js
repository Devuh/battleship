...
describe("Gameboard", () => {
  describe("Place Ship", () => {
    it("Place ship of length 3, direction right at (3,6)", () => {
      ...
      let ship = new Ship(3);
      grid.createShip(3, 6, "right", ship);
    ...
    it("Place ship of length 2, direction down at (10,4)", () => {
      let grid = new Gameboard();
      let ship = new Ship(2);
      expect(() => grid.createShip(10, 4, "down", ship)).toThrow(Error);
    });

    it("Place ship of length 2, direction down at (-1,4)", () => {
      let grid = new Gameboard();
      let ship = new Ship(2);
      expect(() => grid.createShip(-1, 4, "down", ship)).toThrow(Error);
    });

    it("Place ship of length 4, direction right at (9,4)", () => {
      let grid = new Gameboard();
      let ship = new Ship(4);
      expect(() => grid.createShip(9, 4, "right", ship)).toThrow(Error);
    });

    it("Place ship of length 2, direction down at (9,4)", () => {
      let grid = new Gameboard();
      let ship = new Ship(2);
      grid.createShip(9, 4, "down", ship);
      expect(grid.board).toStrictEqual([
        [" ", " ", " ", " ", " ", " ", " ", " ", " ", " "],
        [" ", " ", " ", " ", " ", " ", " ", " ", " ", " "],
        [" ", " ", " ", " ", " ", " ", " ", " ", " ", " "],
    ...
    it("Place ship of length 4, direction down at (9,9)", () => {
      let grid = new Gameboard();
      let ship = new Ship(4);
      expect(() => grid.createShip(9, 9, "down", ship)).toThrow(Error);
    });

    it("Place ship of length 2, direction right at (8,8)", () => {
      let grid = new Gameboard();
      let ship = new Ship(2);
      grid.createShip(8, 8, "right", ship);
      expect(grid.board).toStrictEqual([
        [" ", " ", " ", " ", " ", " ", " ", " ", " ", " "],
        [" ", " ", " ", " ", " ", " ", " ", " ", " ", " "],
        [" ", " ", " ", " ", " ", " ", " ", " ", " ", " "],
    ...
    it("Place ship of length 3, direction right at (4,5) while (5,5) is occupied", () => {
      ...
      grid.createShip(5, 4, "down", ship1);
      expect(() => grid.createShip(4, 5, "right", ship2)).toThrow(Error);
    });
  });
  ...
  describe("Receive Attack", () => {
    ...
    it("Receive attack on ocuppied space (3,5)", () => {
      let grid = new Gameboard();
      let ship = new Ship(3);
      grid.createShip(3, 5, "right", ship);
      grid.receiveAttack(3, 5);
